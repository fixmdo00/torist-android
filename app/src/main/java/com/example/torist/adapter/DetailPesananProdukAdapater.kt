...
class DetailPesananProdukAdapater (private val productList:ArrayList<ProdukDetailPesanan>, val loadingBar : ProgressBar) : RecyclerView.Adapter<DetailPesananProdukAdapater.ProductsViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ProductsViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.item_detail_pesanan_produk,parent,false)
