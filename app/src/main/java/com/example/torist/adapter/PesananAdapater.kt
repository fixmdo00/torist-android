...
class PesananAdapater (private val productList:ArrayList<Pesanan>, val lifecycleOwner : LifecycleOwner, val loadingBar : ProgressBar, val context : Context) : RecyclerView.Adapter<PesananAdapater.ProductsViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ProductsViewHolder, position: Int) {
        ...
        holder.tvNamaToko.text = currentItem.shop_name
        holder.tvAlamatToko.text = currentItem.shop_address
        holder.tvJumlahProduk.text = currentItem.order_products_qty.toString() + " Produk"
        holder.tvStatus.text = StatusPesanan.getStatus(currentItem.order_status)
    ...
    class ProductsViewHolder (itemView : View) : RecyclerView.ViewHolder(itemView){
        ...
        val tvNamaToko : TextView = itemView.findViewById(R.id.itemPesananNamaToko)
        val tvAlamatToko : TextView = itemView.findViewById(R.id.itemPesananAlamaatToko)
